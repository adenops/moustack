...
service_mkdir logstash /openstack/logs
#start_daemon td-agent td-agent

start_daemon logstash java \
	...
	--1.9 /opt/logstash/lib/bootstrap/environment.rb \
	logstash/runner.rb agent -f /etc/logstash/conf.d
