...
public enum StackProperty {
	...
	HEAT_DOMAIN_ADMIN_PASSWORD, HEAT_DELEGATED_ROLE, DB_CEILOMETER_DATABASE, DB_CEILOMETER_USER,
	DB_CEILOMETER_PASSWORD, HOSTNAME, ROLE, KEYSTONE_ADMIN_PROJECT, KEYSTONE_SERVICES_PROJECT, KEYSTONE_ADMIN_ROLE,
	KS_CINDER_USER, HEAT_STACK_USER_ROLE, KS_DESIGNATE_USER, KS_DESIGNATE_PASSWORD, DB_DESIGNATE_PASSWORD,
	DESIGNATE_SERVER_NAME, DHCP_DOMAIN, DESIGNATE_DEFAULT_DOMAIN_ID, SYSLOG_HOST, SYSLOG_PORT;
