...
public enum StackProperty {
	...
	KS_CINDER_USER, HEAT_STACK_USER_ROLE, KS_DESIGNATE_USER, KS_DESIGNATE_PASSWORD, DB_DESIGNATE_PASSWORD, DESIGNATE_SERVER_NAME, DHCP_DOMAIN, DESIGNATE_DEFAULT_DOMAIN_ID;
