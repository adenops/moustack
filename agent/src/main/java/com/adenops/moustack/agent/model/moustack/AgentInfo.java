...
public class AgentInfo {
	...
	public enum LastReportResultEnum {
		UPDATE_SUCCESS("UPDATE_SUCCESS"), UPDATE_NOCHANGE("UPDATE_NOCHANGE"), UPDATE_FAILURE("UPDATE_FAILURE"),
	...
	public boolean equals(java.lang.Object o) {
		...
		return true && Objects.equals(hostname, agentInfo.hostname) && Objects.equals(lastStatus, agentInfo.lastStatus)
	...
	@Override
	public int hashCode() {
		return Objects.hash(hostname, lastStatus, lastStatusDate, lastReportResult, lastReportDate, lastReportId,
				connected);
	}
